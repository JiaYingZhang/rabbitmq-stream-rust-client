...
## [0.9.0](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/compare/rabbitmq-stream-client-v0.8.0...rabbitmq-stream-client-v0.9.0) - 2025-04-24

### Other

- Bump codecov/codecov-action from 5.4.0 to 5.4.2 ([#285](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/pull/285))
- Bump codecov/codecov-action from 5.3.1 to 5.4.0 ([#277](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/pull/277))
- Remove use of `doc(cfg(...))` and the docsrs configuration ([#282](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/pull/282))
- Update fake requirement from 3.0.0 to 4.2.0 ([#281](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/pull/281))
- Fix doc build failed ([#280](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/pull/280))
- Expose LeaderLocator enum ([#279](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/pull/279))
- Dynamic send ([#276](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/pull/276))
- FnOnce as Producer::send callback ([#273](https://github.com/JiaYingZhang/rabbitmq-stream-rust-client/pull/273))
